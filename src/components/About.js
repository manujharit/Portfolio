...
const About = () => {
  ...
  return (
    <div className="mt-[12%] flex flex-col justify-center items-center mx-[5%]">
        ...
        <br/>
        You can contact me on the <a href={GMAIL} target='_blank'><span className='text-red-700 font-bold'>GMail</span> <span className='text-black font-bold underline'>manuj.haritwal01@gmail.com</span></a> or <a href={LINKEDIN} target='_blank' className='font-bold'><span className='text-blue-700'>LinkedIn</span> <span className='text-black underline'>Manuj Haritwal</span></a> or you can DM me on <a href={TWITTER} target='_blank' className='font-bold'><span className='text-blue-500'>Twitter</span> <span className='text-black underline'>Manuj Haritwal</span></a>
        </p>
    </div>
  )
}
