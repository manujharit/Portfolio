...
const Contact = () => {
    const data = [
        { id: 0, user: 'manuj-haritwal', imageId: 'eub6rgmsq4ngfuw3o9cr.png', class: 'text-blue-700 font-bold mb-[10px]' },
        { id: 2, user: 'ManujHarit', imageId: 'eep30q9hzpuppql0tleu.png', class: 'text-black font-bold mb-[10px]' },
    ]
    return (
        <div className="border flex flex-row rounded-3xl drop-shadow-md shadow-md shadow-gray-400 bg-pink-50 h-[350px] px-[7%] py-[10%]">
            <div className=" flex flex-col w-[60%]">
                ...
                <div className="flex flex-row">
                    {data.map(social => <span key={social.id} className="flex flex-row mx-[1%]" ><img src={CDN_URL + social.imageId} className="w-[20px] h-[20px] rounded-md mx-[5px]" /><span className={social.class}>{social.user}</span></span>)}
                </div>
            </div>
